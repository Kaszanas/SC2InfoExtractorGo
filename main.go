...
func main() {
	...
	gameModeCheckFlag := flag.Int("game_mode", 0b1111111111, "Provide which game mode should be included from the processed files in a format of a binary flag: AllGameModes: 0b1111111111")
	...
	localizeMapsBoolFlag := flag.Bool("localize_maps", false, "Set to false if You want to keep the original (possibly foreign) map names.")
